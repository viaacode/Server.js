...
TimegateController.parseTimegateMap = function (mementos, datasources) {
...
TimegateController.parseInvertedTimegateMap = function (mementos, datasources, urlData) {
  ...
  _.forIn(timemaps, function (versions, timeGateId) {
    versions.forEach(function (version) {
      invertedTimegateMap[version.datasourceId] = {
        memento: timeGateId,
        original: (urlData.baseURL || '/') + timeGateId,
...
TimegateController.prototype._handleRequest = function (request, response, next) {
  ...
  if (timemapDetails) {
    ...
    if (memento) {
      ...
      var originalUrl = url.format(_.defaults({ pathname: datasource }, request.parsedUrl));
