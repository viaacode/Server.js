...
function Datasource(options) {
  ...
  // Set the options
  options = options || {};
  this._urlData = options.urlData || new UrlData();
  this._datasourcePath = this._urlData.datasourceBase + encodeURI(options.path || options.id);
  this._blankNodePrefix = (this._urlData.blankNodePath ? this._urlData.baseURLRoot + this._urlData.blankNodePath : 'genid:');
  this.title = options.title;
  this.id = options.id;
  this.hide = options.hide;
  this.path = this._datasourcePath;
  this.url = this._urlData.baseURLRoot + '/' + this._datasourcePath + '#dataset';
  ...
  // TODO: Do this in LDFServerWorker
