...
function CompositeDatasource(options) {
  ...
  if (!options.references)
    throw new Error("A CompositeDatasource requires a `references` object of datasource id's mapping to datasource instances.");

  this._datasources = options.references;
  this._datasourceNames = Object.keys(this._datasources);
